// ==================== 装饰器支持 (优先级最高) ====================
export { observable as Observable, computed as Computed, action as Action, makeObservable, ObservableClass } from './decorators';
...
export {
  defineReactiveClass,
  observable as observableAnnotation,
  computed as computedAnnotation,
  actionAnnotation,
  autobind,
} from './annotations/class';
