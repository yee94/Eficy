...
export const OnMount = createLifecycleDecorator(HookType.ON_MOUNT);
export const OnUnmount = createLifecycleDecorator(HookType.ON_UNMOUNT);
...
export const OnHandleEvent = createLifecycleDecorator(HookType.ON_HANDLE_EVENT);
export const OnBindEvent = createLifecycleDecorator(HookType.ON_BIND_EVENT);
export const OnError = createLifecycleDecorator(HookType.ON_ERROR);
